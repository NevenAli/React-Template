import { alpha, SvgIcon, type Components, type Theme } from "@mui/material";

// نصيحة: فصل المكونات الكبيرة يجعل الملف أسهل في القراءة
...
const MuiCard: Components<Theme>["MuiCard"] = {
  styleOverrides: {
    root: ({ theme }) => {
      ...
      return {
        padding: 16,
        borderRadius: typeof radius === "number" ? radius * 2 : radius,
...
// باقي المكونات من كود الشاب التي كانت ممتازة
  ...
  MuiTableCell: {
    styleOverrides: {
      head: ({ theme }) => ({
        ...
        backgroundColor: theme.palette.background.neutral, // استخدمنا الـ neutral الذي أضفناه!
      }),
    },
  },
  MuiCheckbox: {
